...
namespace OneDrive_Cloud_Player.Services
{
    public class CacheHelper
    {
        ...
        /// </summary>
        public async Task ReadGraphCacheAsync()
        {
            string JsonGraphCache = await JsonHandler.ReadJsonAsync("graphcache.json");
